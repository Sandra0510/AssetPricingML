...
resultfile = "results_NN_Optimal_Bot100.csv"

# Data and NN Settings
data_preparation_settings = [(['mom1m', 'mvel1'], True), (['mom1m', 'mvel1'], False),(['mom1m', 'mvel1', 'retvol'], True), (['mom1m', 'mvel1', 'retvol'], False)]

layer_types = [[16, 8, 4, 2], [16, 8, 4], [8, 4, 2]]
